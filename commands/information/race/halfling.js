...
module.exports.run = async(client, msg, args) => {
    ...
    .addFields(
    { name: 'Appearances', value: `halflings survive in a world full of larger creatures by avoiding notice or avoiding offense. Standing about 3 ft tall, they appear relatively harmless and so have managed to survive for centuries in the shadow of empires and on the edges of wars and political strife. They are stout, weighing between 40 and 45 pounds.
    \nTheir skin ranges from tan to pale with a ruddy cast, and their hair is usually brown or brown and wavy. They have brown or hazel eyes. Their men often sport long sideburns, but beards are rare among them and mustaches even more so. They like to wear simple, comfortable, and practical clothes, favoring bright colors.
    \nTheir practicality extends beyond their clothing. They’re concerned with basic needs and simple pleasures and have little use for ostentation. Even the wealthiest of halflings keep their treasures locked in a cellar rather than on display for all to see. They have a knack for finding the most straightforward solution to a problem and have little patience for dithering.`},
