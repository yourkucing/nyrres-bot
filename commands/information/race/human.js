...
module.exports.run = async(client, msg, args) => {
    ...
    { name: `Ethnicities Part 1`, value: `**Calishite:** Shorter and slighter in build than most other humans, Calishites have dusky brown skin, hair, and eyes. They’re found primarily in southwest Faerûn.
    ...
    { name: `Ethnicities Part 3`, value: `**Tethyrian:** Widespread along the entire Sword Coast at the western edge of Faerûn, Tethyrians are of medium build and height, with dusky skin that tends to grow fairer the farther north they dwell. Their hair and eye color varies widely, but brown hair and blue eyes are the most common.
